<%-- 
    Document   : LoginAdmin
    Created on : 02-may-2015, 15:20:16
...
<div class="wrapper">
  <div id="latest">
    <div class="fl_left2">
        <form id="formInicioUser" action="ServletLoginAdmin" method="Post">
            <h2 >Ingresa los datos para iniciar sesion</h2> <br>
            <input class="form-control"  name="txtUsuario" type="text" placeholder="Digite su Nombre de usuario"/> <br> <br>
            <input class="form-control"  name="txtPass" type="password" placeholder="Digite su contraseña"/> <br> 
            <div><button class="btn btn-primary" id="btnIngresar" />Ingresar</div>
        </form>
...
<div class="wrapper">
  <div id="container">
    <div id="content">
      <% if (request.getAttribute("errorInicioAdmin") != null)   {%>  
        ${errorInicioAdmin}
      <%}%>  
    </div>
      </div>
